...
def _reject_external_weights(use_imagenet_weights):
    if use_imagenet_weights:
        raise ValueError("External ImageNet weights are not bundled with this release.")


def resnet18(use_imagenet_weights=False, **kwargs):
    """Constructs a ResNet-18 model.

    Args:
        use_imagenet_weights (bool): external ImageNet initialization is disabled in this release.
    """
    _reject_external_weights(use_imagenet_weights)
    model = ResNet(BasicBlock, [2, 2, 2, 2], **kwargs)
    return model


def resnet34(use_imagenet_weights=False, **kwargs):
...
def resnet50(use_imagenet_weights=False, **kwargs):
...
def resnet101(use_imagenet_weights=False, **kwargs):
...
def resnet152(use_imagenet_weights=False, **kwargs):
