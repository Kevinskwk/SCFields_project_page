...
class Resnet101_8s(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        # Build the backbone, remove avg pool, and get the output stride of 8.
...
class Resnet18_16s(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        # Build the backbone, remove avg pool, and get the output stride of 16.
...
class Resnet18_32s(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        # Build the backbone, remove avg pool, and get the output stride of 32.
